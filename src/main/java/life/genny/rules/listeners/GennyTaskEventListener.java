...
public class GennyTaskEventListener implements TaskLifeCycleEventListener {

    private RuntimeManagerRegistry registry = RuntimeManagerRegistry.get();
    private static final Logger logger = LoggerFactory.getLogger(GennyTaskEventListener.class);

    private PredictionService predictionService = PredictionServiceRegistry.get().getService();

    public GennyTaskEventListener() {
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null)
            return false;
        if ((obj instanceof GennyTaskEventListener))
            return true;
