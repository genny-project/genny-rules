...
public class SendSignalToWorkflowWorkItemHandler implements WorkItemHandler {
  ...
  public <R> SendSignalToWorkflowWorkItemHandler(
      Class<R> workflowQueryInterface, RuntimeEngine rteng) {
  ...
  public void executeWorkItem(WorkItem workItem, WorkItemManager manager) {
    ...
    if (processId == null) {
      ...
      // Optional<Long> processIdBysessionId = w.getProcessIdBysessionId(userToken.getJTI());
    ...
    if (processId != null) {
      ...
      log.info(
          callingWorkflow
              + ": Sending Payload Object  to processId "
              + processId
              + " for target user "
